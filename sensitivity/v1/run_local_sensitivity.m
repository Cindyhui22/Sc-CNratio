...
error_ref = func_chemo_error(WT_y_steady_clim,   WT_met_reac_steady_clim, ...
                          WT_y_steady_cnlim1, WT_met_reac_steady_cnlim1, ...
                          WT_y_steady_cnlim2, WT_met_reac_steady_cnlim2, ...
...
error_preturb(i) = func_chemo_error(WT_y_steady_clim,   WT_met_reac_steady_clim, ...
                                  WT_y_steady_cnlim1, WT_met_reac_steady_cnlim1, ...
                                  WT_y_steady_cnlim2, WT_met_reac_steady_cnlim2, ...
                                  WT_y_steady_nlim,   WT_met_reac_steady_nlim, ...
                                  num_y, num_flux, num_prot, ...
...
%%
% save data
% save('local_sensi.mat', "parName","sorted_parName", "S", "sorted_S", "ind_order", "error_preturb","error_ref","delta", "par_sto");
%
