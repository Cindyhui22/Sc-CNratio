...
elseif strcmp(mutant,'hap4_underexpress') 

mutant_type = 'const_gl_eh_aaex_cell_hap_under'; % constant snf1, glucose, ethanol, constant cells 

elseif strcmp(mutant,'hap4_overexpress') 

mutant_type = 'const_gl_eh_aaex_cell_hap_over'; % constant snf1, glucose, ethanol, constant cells 
...
elseif strcmp(mutant,'addH') 
mutant_type = 'const_gl_eh_aaex_cell_addH';
end
